...
<body class="bg-gray-900 text-white">
    <div class="container mx-auto mt-10">
        <div class="text-center mb-6">
            <img src="https://qi.edu.br/wp-content/uploads/2023/09/faqi-300x116-1.png" alt="FAQI Logo" class="mx-auto">
            <p class="mt-2">Projeto desenvolvido para fins acadêmicos. FAQI</p>
        </div>

        <body class="bg-gray-900 text-white">
            <div class="container mx-auto mt-10">
                <h2 class="text-3xl font-bold mb-6 text-center">CLIENTES FAQI</h2>
